...
import { getBranches, getCategories, getSiteSettings } from "@/lib/api";
...
export default async function LocaleLayout({
  ...
  const [messages, categories, branches, settings, t] = await Promise.all([
    getMessages(),
    getCategories(),
    getBranches(),
    getSiteSettings(),
      ...
      <body className="flex min-h-screen flex-col bg-paper font-sans text-ink">
        ...
        <NextIntlClientProvider messages={messages}>
          <CustomerAuthProvider>
            <CartProvider>
              <Header categories={categories} cashbackPercent={settings.cashbackPercent} />
