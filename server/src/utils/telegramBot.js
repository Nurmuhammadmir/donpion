...
async function handleStart(msg, registrationId) {
  ...
  if (!registrationId) {
    ...
    await sendTelegramMessage(
      chatId,
      "Здравствуйте! 🌸 Вы в Telegram-боте DonPion — цветочного дома, который создаёт букеты, говорящие то, что сложно сказать словами.\n\n" +
        "Каждый букет собираем с любовью в день заказа 💐 А перед доставкой присылаем фото — вы увидите его раньше получателя!\n\n" +
        "🕐 Работаем ежедневно, с 7:00 до 23:00\n" +
        "📞 +998 87 835-35-08\n" +
        "📷 instagram.com/donpion.uz\n\n" +
        "Хотите порадовать кого-то (или себя)? 🌷 Открывайте приложение ниже и выбирайте букет!",
